...
void dssv(struct sinhvien sv[], int n)
{
    ...
    printf("\n---------------------------------------------------------------------------\n");
    printf("| %-15s| %-25s| %-11s| %-15s|\n","Masv", "Ho ten", "Gioi tinh", "Ngay sinh");
    printf("---------------------------------------------------------------------------\n");
    
    for (int i = 0; i < n; i++)
    {
        printf("| %-15ld| %-25s| %-11s| %-15s|\n",
        sv[i].msv,sv[i].hovaten,sv[i].gioitinh,sv[i].ngaysinh);
    }
...
void diemtb(struct sinhvien sv[], int n)
{
    ...
    printf(" ==XUAT DANH SACH SINH VIEN==");
    printf("\n---------------------------------------------------------------------------------------------------------------\n");
    printf("| %-15s| %-25s| %-11s| %-15s| %-17s| %-15s|\n","Masv", "Ho ten", "Gioi tinh", "Ngay sinh","Diem trung binh");
    printf("---------------------------------------------------------------------------------------------------------------\n");
    
    for (int i = 0; i < n; i++)
    {
        printf("| %-15ld| %-25s| %-11s| %-15s| %-17.2f| %-15s|\n",
        sv[i].msv,sv[i].hovaten,sv[i].gioitinh,sv[i].ngaysinh,sv[i].diemtb);
    }
